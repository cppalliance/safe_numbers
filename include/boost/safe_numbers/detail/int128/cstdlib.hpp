...
BOOST_SAFE_NUMBERS_DETAIL_INT128_EXPORT struct u128div_t
{
    uint128_t quot;
    uint128_t rem;
};

BOOST_SAFE_NUMBERS_DETAIL_INT128_EXPORT struct i128div_t
{
    int128_t quot;
    int128_t rem;
};

BOOST_SAFE_NUMBERS_DETAIL_INT128_EXPORT BOOST_SAFE_NUMBERS_DETAIL_INT128_HOST_DEVICE constexpr u128div_t div(const uint128_t x, const uint128_t y) noexcept
{
    if (BOOST_SAFE_NUMBERS_DETAIL_INT128_UNLIKELY(x == 0U || y == 0U))
    {
...
BOOST_SAFE_NUMBERS_DETAIL_INT128_EXPORT BOOST_SAFE_NUMBERS_DETAIL_INT128_HOST_DEVICE constexpr i128div_t div(const int128_t x, const int128_t y) noexcept
{
    if (BOOST_SAFE_NUMBERS_DETAIL_INT128_UNLIKELY(x == 0 || y == 0))
    {
...
#endif // BOOST_SAFE_NUMBERS_DETAIL_INT128_CSTDLIB_HPP
