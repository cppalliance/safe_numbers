...
def __lldb_init_module(debugger, internal_dict):
    ...
    u8_pattern = r"^(const )?(boost::safe_numbers::detail::unsigned_integer_basis<unsigned char>|([A-Za-z0-9_]+::)*u8)( &| \*)?$"
    u16_pattern = r"^(const )?(boost::safe_numbers::detail::unsigned_integer_basis<unsigned short>|([A-Za-z0-9_]+::)*u16)( &| \*)?$"
    u32_pattern = r"^(const )?(boost::safe_numbers::detail::unsigned_integer_basis<unsigned int>|([A-Za-z0-9_]+::)*u32)( &| \*)?$"
    u64_pattern = r"^(const )?(boost::safe_numbers::detail::unsigned_integer_basis<unsigned long>|boost::safe_numbers::detail::unsigned_integer_basis<unsigned long long>|([A-Za-z0-9_]+::)*u64)( &| \*)?$"
    u128_pattern = r"^(const )?(boost::safe_numbers::detail::unsigned_integer_basis<boost::safe_numbers::int128::uint128_t>|([A-Za-z0-9_]+::)*u128)( &| \*)?$"
    bounded_uint_pattern = r"^(const )?boost::safe_numbers::bounded_uint<[^>]+>( &| \*)?$"
    i8_pattern = r"^(const )?(boost::safe_numbers::detail::signed_integer_basis<signed char>|([A-Za-z0-9_]+::)*i8)( &| \*)?$"
    i16_pattern = r"^(const )?(boost::safe_numbers::detail::signed_integer_basis<short>|([A-Za-z0-9_]+::)*i16)( &| \*)?$"
    i32_pattern = r"^(const )?(boost::safe_numbers::detail::signed_integer_basis<int>|([A-Za-z0-9_]+::)*i32)( &| \*)?$"
    i64_pattern = r"^(const )?(boost::safe_numbers::detail::signed_integer_basis<long>|boost::safe_numbers::detail::signed_integer_basis<long long>|([A-Za-z0-9_]+::)*i64)( &| \*)?$"
    i128_pattern = r"^(const )?(boost::safe_numbers::detail::signed_integer_basis<boost::safe_numbers::int128::int128_t>|([A-Za-z0-9_]+::)*i128)( &| \*)?$"
    bounded_int_pattern = r"^(const )?boost::safe_numbers::bounded_int<[^>]+>( &| \*)?$"
    f32_pattern = r"^(const )?(boost::safe_numbers::detail::float_basis<float>|([A-Za-z0-9_]+::)*f32)( &| \*)?$"
    f64_pattern = r"^(const )?(boost::safe_numbers::detail::float_basis<double>|([A-Za-z0-9_]+::)*f64)( &| \*)?$"
