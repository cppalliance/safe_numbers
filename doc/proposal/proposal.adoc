...
.This https://github.com/cppalliance/safe_numbers/examples/construction_and_conversion.cpp[example] demonstrates how a user can construct a safe unsigned integer, and convert it back to builtin
====
[source, c++]
----
