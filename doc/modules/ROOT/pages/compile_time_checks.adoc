...
See https://wg21.link/P4021[P4021] and https://github.com/jonnygrant/compile_assert[the reference implementation] thereof both by Jonathan Grant for additional information.
