...
These policies apply to the integer types.
The floating-point types `f32` and `f64` follow IEEE 754 semantics instead: they do not participate in the policy model, and their exceptional results (saturation to infinity, invalid operations, and NaN) are reported as exceptions directly.
