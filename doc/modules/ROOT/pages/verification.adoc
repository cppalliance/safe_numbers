...
What the verification does establish is that the overflow, underflow, and edge-case detection logic is correct for every input in the relevant residue class, including the asymmetric cases such as `INT_MIN / -1` and `-INT_MIN`.
