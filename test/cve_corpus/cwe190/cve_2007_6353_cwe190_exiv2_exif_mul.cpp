...
// cwe:                CWE-190
// product:            Exiv2 (exif.cpp)
// version:            Exiv2 library
// summary:            Integer overflow in Exiv2 (exif.cpp).
// root-cause:         unsigned multiplication of two values
// root-cause-width:   u32
// trigger:            count=1500000000, element_size=3
...
void native_reproduction()
{
    ...
    const std::uint32_t element_size {3U};
    ...
    BOOST_TEST_EQ(bytes, 205032704U);
