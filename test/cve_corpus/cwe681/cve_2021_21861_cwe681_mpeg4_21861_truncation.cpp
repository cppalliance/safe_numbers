...
{
    const std::uint32_t value {100000U};
    const std::uint16_t field {static_cast<std::uint16_t>(value)};

    BOOST_TEST_EQ(field, static_cast<std::uint16_t>(34464U));
