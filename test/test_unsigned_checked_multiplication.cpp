...
void test_valid_multiplication()
{
    ...
    for (std::size_t i = 0; i < N; ++i)
    {
        ...
        BOOST_TEST_EQ(res.value(), ref_value);
    }
}

template <typename T>
void test_checked_multiplication()
{
    using basis_type = detail::underlying_type_t<T>;
...
int main()
{
    ...
    test_checked_multiplication<u8>();

    test_valid_multiplication<u16>();
    test_checked_multiplication<u16>();

    test_valid_multiplication<u32>();
    test_checked_multiplication<u32>();

    test_valid_multiplication<u64>();
    test_checked_multiplication<u64>();

    test_valid_multiplication<u128>();
    test_checked_multiplication<u128>();
