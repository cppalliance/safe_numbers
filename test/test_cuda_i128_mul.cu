...
int main(void)
{
    ...
    // isqrt(INT128_MAX) fits in an int64_t range: use INT64_MAX as safe bound
    boost::random::uniform_int_distribution<basis_type> dist{static_cast<basis_type>(-static_cast<basis_type>(INT64_MAX)), static_cast<basis_type>(INT64_MAX)};
