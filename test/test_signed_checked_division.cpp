...
void test_valid_division()
{
    ...
    for (std::size_t i {0}; i < N; ++i)
    {
        ...
        const auto res {checked_div(lhs, rhs)};
...
template <typename T>
void test_checked_min_div_neg1()
{
    using basis_type = detail::underlying_type_t<T>;
    ...
    // min / -1 overflows in two's complement, checked returns nullopt
    BOOST_TEST(!res.has_value());
}
...
int main()
{
    ...
    test_checked_div_by_zero<i8>();
    test_checked_min_div_neg1<i8>();

    test_valid_division<i16>();
    test_checked_div_by_zero<i16>();
    test_checked_min_div_neg1<i16>();

    test_valid_division<i32>();
    test_checked_div_by_zero<i32>();
    test_checked_min_div_neg1<i32>();

    test_valid_division<i64>();
    test_checked_div_by_zero<i64>();
    test_checked_min_div_neg1<i64>();

    test_valid_division<i128>();
    test_checked_div_by_zero<i128>();
    test_checked_min_div_neg1<i128>();
