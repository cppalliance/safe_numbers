...
int main(void)
{
    ...
    std::uniform_int_distribution<std::int32_t> dist{static_cast<std::int32_t>((std::numeric_limits<basis_type>::min)() / 2), static_cast<std::int32_t>((std::numeric_limits<basis_type>::max)() / 2)};
