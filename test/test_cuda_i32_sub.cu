...
using test_type = boost::safe_numbers::i32;
...
int main(void)
{
    ...
    std::uniform_int_distribution<basis_type> dist{(std::numeric_limits<basis_type>::min)() / 4, (std::numeric_limits<basis_type>::max)() / 4};
