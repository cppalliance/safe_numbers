...
void test_valid_multiplication()
{
    ...
    // Use a narrow range to avoid overflow: sizeof*8 is safe for all types
...
template <typename T>
void test_overflowed_multiplication()
{
    using basis_type = detail::underlying_type_t<T>;
    ...
    for (std::size_t i {0}; i < N; ++i)
    {
        ...
        constexpr basis_type rhs_value {2};
...
int main()
{
    ...
    test_overflowed_multiplication<i8>();

    test_valid_multiplication<i16>();
    test_overflowed_multiplication<i16>();

    test_valid_multiplication<i32>();
    test_overflowed_multiplication<i32>();

    test_valid_multiplication<i64>();
    test_overflowed_multiplication<i64>();

    test_valid_multiplication<i128>();
    test_overflowed_multiplication<i128>();
