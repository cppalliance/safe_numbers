...
void test_valid_division()
{
    ...
    for (std::size_t i = 0; i < N; ++i)
    {
        ...
        const T res {wrapping_div(lhs, rhs)};
...
void test_division_by_zero_throws()
{
    ...
    BOOST_TEST_THROWS(wrapping_div(lhs, rhs), std::domain_error);
}

int main()
{
    test_valid_division<u8>();
    test_division_by_zero_throws<u8>();

    test_valid_division<u16>();
    test_division_by_zero_throws<u16>();

    test_valid_division<u32>();
    test_division_by_zero_throws<u32>();

    test_valid_division<u64>();
    test_division_by_zero_throws<u64>();

    test_valid_division<u128>();
    test_division_by_zero_throws<u128>();
