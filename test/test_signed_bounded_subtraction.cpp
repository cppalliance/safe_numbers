...
void test_i8_valid_subtraction()
{
    // Basic subtraction: 50 - 30 = 20
    constexpr bounded_int<-100, 100> a {i8{50}};
    constexpr bounded_int<-100, 100> b {i8{30}};
    const auto c {a - b};
    const bounded_int<-100, 100> expected {i8{20}};
    ...
    // Positive - negative: 30 - (-20) = 50
    constexpr bounded_int<-100, 100> e {i8{30}};
    constexpr bounded_int<-100, 100> f {i8{-20}};
    const auto g {e - f};
    const bounded_int<-100, 100> expected_g {i8{50}};
    BOOST_TEST(g == expected_g);

    // Negative result: 20 - 50 = -30
    constexpr bounded_int<-100, 100> h {i8{20}};
    constexpr bounded_int<-100, 100> i {i8{50}};
    const auto j {h - i};
    const bounded_int<-100, 100> expected_j {i8{-30}};
...
{
    // -128 - 127 would underflow the underlying i8 type
    constexpr bounded_int<-128, 127> a {i8{-128}};
    constexpr bounded_int<-128, 127> b {i8{127}};
    BOOST_TEST_THROWS(a - b, std::underflow_error);

    // 127 - (-127) = 254, overflows underlying i8
    constexpr bounded_int<-128, 127> c {i8{127}};
    constexpr bounded_int<-128, 127> d {i8{-127}};
    BOOST_TEST_THROWS(c - d, std::overflow_error);
}
...
void test_i16_valid_subtraction()
{
    constexpr bounded_int<-1000, 1000> a {i16{500}};
    constexpr bounded_int<-1000, 1000> b {i16{300}};
    const auto c {a - b};
    const bounded_int<-1000, 1000> expected {i16{200}};
    BOOST_TEST(c == expected);

    // Negative result: -300 - 400 = -700
    constexpr bounded_int<-1000, 1000> d {i16{-300}};
    constexpr bounded_int<-1000, 1000> e {i16{400}};
    const auto f {d - e};
    const bounded_int<-1000, 1000> expected_f {i16{-700}};
    BOOST_TEST(f == expected_f);
}

void test_i16_out_of_range_subtraction()
{
...
void test_i32_valid_subtraction()
{
    constexpr bounded_int<-100000, 100000> a {i32{70000}};
    constexpr bounded_int<-100000, 100000> b {i32{30000}};
    const auto c {a - b};
    const bounded_int<-100000, 100000> expected {i32{40000}};
    BOOST_TEST(c == expected);

    // Subtracting a negative: 50000 - (-30000) = 80000
    constexpr bounded_int<-100000, 100000> d {i32{50000}};
    constexpr bounded_int<-100000, 100000> e {i32{-30000}};
    const auto f {d - e};
    const bounded_int<-100000, 100000> expected_f {i32{80000}};
    BOOST_TEST(f == expected_f);
}

void test_i32_out_of_range_subtraction()
{
...
void test_i64_valid_subtraction()
{
    constexpr bounded_int<-3000000000LL, 3000000000LL> a {i64{2000000000LL}};
    constexpr bounded_int<-3000000000LL, 3000000000LL> b {i64{500000000LL}};
    const auto c {a - b};
    const bounded_int<-3000000000LL, 3000000000LL> expected {i64{1500000000LL}};
    BOOST_TEST(c == expected);
}

void test_i64_out_of_range_subtraction()
{
...
void test_compound_subtraction()
{
    ...
    a -= bounded_int<-100, 100>{i8{30}};
    const bounded_int<-100, 100> expected_a {i8{20}};
    BOOST_TEST(a == expected_a);

    // i16 basis
    bounded_int<-1000, 1000> b {i16{500}};
    b -= bounded_int<-1000, 1000>{i16{300}};
    const bounded_int<-1000, 1000> expected_b {i16{200}};
    BOOST_TEST(b == expected_b);

    // i32 basis
    bounded_int<-100000, 100000> c {i32{70000}};
    c -= bounded_int<-100000, 100000>{i32{30000}};
    const bounded_int<-100000, 100000> expected_c {i32{40000}};
    BOOST_TEST(c == expected_c);

    // i64 basis
    bounded_int<-3000000000LL, 3000000000LL> d {i64{2000000000LL}};
    d -= bounded_int<-3000000000LL, 3000000000LL>{i64{500000000LL}};
    const bounded_int<-3000000000LL, 3000000000LL> expected_d {i64{1500000000LL}};
...
void test_constexpr_subtraction()
{
    ...
    constexpr bounded_int<-100, 100> expected {i8{20}};
    static_assert(c == expected);

    constexpr bounded_int<-1000, 1000> d {i16{500}};
    constexpr bounded_int<-1000, 1000> e {i16{800}};
    constexpr auto f {d - e};
    constexpr bounded_int<-1000, 1000> expected_f {i16{-300}};
    static_assert(f == expected_f);

    constexpr bounded_int<-100000, 100000> g {i32{0}};
    constexpr bounded_int<-100000, 100000> h {i32{50000}};
    constexpr auto i {g - h};
    constexpr bounded_int<-100000, 100000> expected_i {i32{-50000}};
    static_assert(i == expected_i);
}

int main()
{
    test_i8_valid_subtraction();
    test_i8_out_of_range_positive();
    test_i8_out_of_range_negative();
    test_i8_underlying_overflow();

    test_i16_valid_subtraction();
    test_i16_out_of_range_subtraction();

    test_i32_valid_subtraction();
    test_i32_out_of_range_subtraction();

    test_i64_valid_subtraction();
    test_i64_out_of_range_subtraction();
