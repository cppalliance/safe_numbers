...
int main()
{
    ...
    test_checked_overflow<i8>();
    test_checked_underflow<i8>();

    test_valid_subtraction<i16>();
    test_checked_overflow<i16>();
    test_checked_underflow<i16>();

    test_valid_subtraction<i32>();
    test_checked_overflow<i32>();
    test_checked_underflow<i32>();

    test_valid_subtraction<i64>();
    test_checked_overflow<i64>();
    test_checked_underflow<i64>();

    test_valid_subtraction<i128>();
    test_checked_overflow<i128>();
    test_checked_underflow<i128>();
