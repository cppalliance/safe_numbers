...
using test_type = boost::safe_numbers::bounded_float<0.0f, 1000.0f>;
...
int main()
{
    ...
    // 600 + 600 = 1200 exceeds the [0, 1000] bound -> out of range
    for (int i = 0; i < numElements; ++i)
    {
        A[i] = test_type{basis_type{600.0f}};
        B[i] = test_type{basis_type{600.0f}};
    }
